            ...
            <div class="report-filter">
                <form method="post" class="" action="<?php echo base_url() . "index.php/" . $this->uri->segment(1, 0) . "/generate_report/" ?>">
                    <div class="start-time">
                        ...
                        <input type="text" title="<?php echo $this->lang->line('tooltip_monthly'); ?>" readonly required <?php echo (isset($start_date) ? 'value = "' . $start_date . '"' : ''); ?> id="month_pickup" name="start_date" class="">
