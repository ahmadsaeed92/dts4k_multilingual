            ...
            <div class="report-filter">
                <form method="post" class="start_end_form" action="<?php echo base_url() . "index.php/" . $this->uri->segment(1, 0) . "/generate_report/" ?>">
                    <div class="start-time">
                        ...
                        <input type="text" title="<?php echo $this->lang->line('tooltip_start_datetime_custom'); ?>" required <?php echo (isset($start_date) ? 'value = "' . $start_date . '"' : ''); ?> id="custom_start_dt" name="start_date" class="datepicker datepicker_start">
                    ...
                    <div class="end-time">
                        ...
                        <input type="text" title="<?php echo $this->lang->line('tooltip_end_datetime_custom'); ?>" required <?php echo (isset($end_date) ? 'value = "' . $end_date . '"' : ''); ?> id="custom_end_dt" name="end_date" class="datepicker datepicker_end">
                    </div>
